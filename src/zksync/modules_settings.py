...
async def bridge_zksync(account_id, key, proxy, data):
    """
    ...
    min_amount = 0
    max_amount = data.get("amount_bridge")
    decimal = 4
...
async def swap_syncswap(account_id, key, proxy, data, **kwargs):
    """
...
async def liquidity_syncswap(account_id, key, proxy):
    ...
    syncswap = SyncSwap(account_id, key, proxy)
    return await syncswap.add_liquidity(min_amount, max_amount, decimal, all_amount, min_percent, max_percent)


async def swap_mute(account_id, key, proxy, data, **kwargs):
    """
    Make swap on Mute
    ______________________________________________________
    ...
    return await mute.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                    max_percent)


async def swap_spacefi(account_id, key, proxy, data, **kwargs):
    """
    ...
    return await spacefi.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                       max_percent)
...
async def liquidity_spacefi(account_id, key, proxy):
    ...
    spacefi = SpaceFi(account_id, key, proxy)
    return await spacefi.add_liquidity(min_amount, max_amount, decimal, all_amount, min_percent, max_percent)


async def swap_pancake(account_id, key, proxy, data, **kwargs):
    """
    ...
    return await pancake.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                       max_percent)


async def swap_woofi(account_id, key, proxy, data, **kwargs):
    """
    Make swap on WooFi
    ______________________________________________________
    from_token – Choose SOURCE token ETH, USDC | Select one
    ...
    return await woofi.swap(
        from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent, max_percent
    )


async def swap_odos(account_id, key, proxy, data, **kwargs):
    """
    Make swap on Odos
    ______________________________________________________
...
async def swap_zkswap(account_id, key, proxy, data, **kwargs):
    """
    Make swap on ZkSwap
    ______________________________________________________
    from_token – Choose SOURCE token ETH, USDC | Select one
    ...
    return await zkswap.swap(
        from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent, max_percent
    )


async def swap_xyswap(account_id, key, proxy, data, **kwargs):
    """
    Make swap on XYSwap
    ______________________________________________________
    ...
    return await xyswap.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                      max_percent)


async def swap_openocean(account_id, key, proxy, data, **kwargs):
    """
...
async def swap_inch(account_id, key, proxy, data, **kwargs):
    """
    Make swap on 1inch
    ______________________________________________________
    ...
    return await inch_dex.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                        max_percent)


async def swap_maverick(account_id, key, proxy, data, **kwargs):
    """
    ...
    return await maverick.swap(from_token, to_token, min_amount, max_amount, decimal, slippage, all_amount, min_percent,
                        max_percent)


async def swap_vesync(account_id, key, proxy, data, **kwargs):
    """
    Make swap on VeSync
    ______________________________________________________
    from_token – Choose SOURCE token ETH, USDC | Select one
...
async def mint_tavaera(account_id, key, proxy, data, **kwargs):
    """
...
async def mint_nft(account_id, key, proxy, data, **kwargs):
    """
    Mint NFT on NFTS2ME
    ______________________________________________________
...
########### NO NEED TO CHANGE ###########
#########################################
async def send_mail(account_id, key, proxy, data, **kwargs):
    dmail = Dmail(account_id, key, proxy)
    await dmail.send_mail()


async def send_message(account_id, key, proxy, data, **kwargs):
    l2telegraph = L2Telegraph(account_id, key, proxy)
    await l2telegraph.send_message()


async def mint_mailzero_nft(account_id, key, proxy, data, **kwargs):
    mint_nft = MailZero(account_id, key, proxy)
    await mint_nft.mint()


async def mint_zks_domain(account_id, key, proxy, data, **kwargs):
    zks_domain = ZKSDomain(account_id, key, proxy)
    await zks_domain.mint()


async def mint_era_domain(account_id, key, proxy, data, **kwargs):
